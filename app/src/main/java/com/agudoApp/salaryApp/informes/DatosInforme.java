...
public class DatosInforme extends Activity {
	...
	private EditText textoNombreInforme;
	private int mes;
	private int anio;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.datos_informes);
		...
		spinnerInforme = (Spinner) findViewById(R.id.spinnerInforme);
		spinnerNomina = (Spinner) findViewById(R.id.spinnerNominaInforme);
		spinnerAnios = (Spinner) findViewById(R.id.spinnerAniosInforme);
		botonFechaDesde = (Button) findViewById(R.id.botonFechaInformeDesde);
		botonFechaHasta = (Button) findViewById(R.id.botonFechaInformeHasta);
		textoDesde = (TextView) findViewById(R.id.textoFechaDesdeInforme);
		textoHasta = (TextView) findViewById(R.id.textoFechaHastaInforme);
		textoMeses = (TextView) findViewById(R.id.textoNominasInforme);
		checkCategorias = (CheckBox) findViewById(R.id.checkInformesCategorias);
		textoCategorias = (TextView) findViewById(R.id.textoInformesCategorias);
		checkCategorias2 = (CheckBox) findViewById(R.id.checkInformesCategorias2);
		textoCategorias2 = (TextView) findViewById(R.id.textoInformesCategorias2);
		botonGenerar = (Button) findViewById(R.id.botonGenerar);
		botonCancelar = (Button) findViewById(R.id.botonCancelarInforme);
		botonGenerar2 = (Button) findViewById(R.id.botonGenerar2);
		botonCancelar2 = (Button) findViewById(R.id.botonCancelarInforme2);
		textoNombreInforme = (EditText) findViewById(R.id.cajaNombreInforme);
		TextView nombreInforme = (TextView) findViewById(R.id.NombreInforme);
		TextView generarPor = (TextView) findViewById(R.id.GenerarPor);
		TextView textoNominasInforme = (TextView) findViewById(R.id.textoNominasInforme);

		// Definimos el tipo de fuente
		Typeface miPropiaTypeFace = Typeface.createFromAsset(getAssets(),
				"fonts/Berlin.ttf");

		nombreInforme.setTypeface(miPropiaTypeFace);
		generarPor.setTypeface(miPropiaTypeFace);
		textoNominasInforme.setTypeface(miPropiaTypeFace);
		...
		botonGenerar.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				onCreateDialog(MENSAJE_ALERTA_1);
		...
		botonGenerar2.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				onCreateDialog(MENSAJE_ALERTA_2);
			}
		});
	...
	protected Dialog onCreateDialog(int id) {
					...
					new DialogInterface.OnClickListener() {
						public void onClick(DialogInterface dialog, int id) {
							try {
								...
								if (db != null) {
									if (mostrarNominas) {
										listMov = gestion.getMovimientosExcel(
												db, mes, anio, idCuenta);
									} else {
										listMov = gestion
												.getMovimientosExcelMes(db,
														mes, anio, idCuenta);
									}
								}
								db.close();
								Informes.CrearExcel(textoNombreInforme
										.getText().toString(), listMov);
		...
		case MENSAJE_ALERTA_2:
					...
					new DialogInterface.OnClickListener() {
						public void onClick(DialogInterface dialog, int id) {
							try {
								...
								ArrayList<Movimiento> listMov = new ArrayList<Movimiento>();
								Date fechaDes = new Date(mYearD - 1900,
										mMonthD, mDayD);
								Date fechaHas = new Date(mYearH - 1900,
										mMonthH, mDayH);
								...
								if (db != null) {
									movimientos = gestion
											.consultarMovimientosExcel(db,
													fechaDes, fechaHas,
													idCuenta);
								}
								listMov = GestionBBDD
										.obtenerDatosMovimientosExcel(movimientos);
								db.close();
								Informes.CrearExcel(textoNombreInforme
										.getText().toString(), listMov);
								onCreateDialog(MENSAJE_OK);
			...
			break;
		case MENSAJE_OK:
			builder.setMessage(getResources().getString(R.string.excelOK))
			...
			break;
		case MENSAJE_KO:
			builder.setMessage(getResources().getString(R.string.excelKO))
					.setTitle(getResources().getString(R.string.info))
					.setIcon(R.drawable.ic_alert)
					.setPositiveButton(
							getResources().getString(R.string.aceptar),
	...
	public void obtenerOpcionesInfome() {
		...
		spinnerInforme.setAdapter(adapter);
