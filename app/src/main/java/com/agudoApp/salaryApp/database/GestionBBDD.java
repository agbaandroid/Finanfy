...
public class GestionBBDD {
	...
	public void actualizarBDCuentas(SQLiteDatabase db) {
		...
		if (!c1.moveToFirst()) {
			...
			if (languaje.equals("es") || languaje.equals("es-rUS")
				...
				db.execSQL("INSERT INTO Cuentas VALUES(0, 'Compte principal')");
			} else if (languaje.equals("de")) {
				db.execSQL("INSERT INTO Cuentas VALUES(0, 'Master-Account')");
			} else if (languaje.equals("en")) {
				db.execSQL("INSERT INTO Cuentas VALUES(0, 'Master account')");
			} else if (languaje.equals("it")) {
				db.execSQL("INSERT INTO Cuentas VALUES(0, 'Account principale')");
			} else if (languaje.equals("pt")) {
				db.execSQL("INSERT INTO Cuentas VALUES(0, 'Conta principal')");
			} else {
				db.execSQL("INSERT INTO Cuentas VALUES(0, 'Master account')");
			}
	...
	public List<Recibo> getRecibos(SQLiteDatabase db, int idCuenta) {
		...
		Cursor c1 = db.rawQuery("select * from Recibos where idCuenta='"
				+ idCuenta + "'", null);
	...
	public boolean insertarRecibo(SQLiteDatabase db, Float cantidad,
			String desc, Date fechaD, Date fechaH, int idCat, int idSub,
			boolean tarjeta, int idTarjeta, int idCuenta) {
		try {
			String sql = "INSERT INTO Recibos VALUES(" + null + "," + cantidad
					+ ", " + "'" + desc + "'," + idCat + ", " + idSub + ", "
					+ "'" + fechaD + "', " + "'" + fechaH + "',  " + "'"
					+ tarjeta + "', " + "'" + idTarjeta + "', '" + idCuenta
					+ "')";
			db.execSQL(sql);
			return true;
		} catch (Exception e) {
	...
	public boolean addTarjeta(SQLiteDatabase db, String tarjeta, float cant) {
		try {
	...
	public boolean addCuenta(SQLiteDatabase db, String cuenta) {
		try {
	...
	public boolean editTarjeta(SQLiteDatabase db, String descripcion, String id) {
		try {
			ContentValues values = new ContentValues();
	...
	public boolean editarRecibo(SQLiteDatabase db, String id, Float cantidad,
