...
import com.agudoApp.salaryApp.activities.EditSubTexto;
import com.agudoApp.salaryApp.model.Categoria;
import com.agudoApp.salaryApp.util.Util;

public class ListaAdapterPestanaSubExpandibleAdapter extends
	...
	public ListaAdapterPestanaSubExpandibleAdapter(Context context,
	...
	public View getChildView(int groupPosition, final int childPosition,
		...
		layoutEdit.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				Intent intent = new Intent(_context, EditSubTexto.class);
		...
		layoutDelete.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				Intent intent = new Intent(_context, DeleteSub.class);
				intent.putExtra("id", categoria.getId());
				intent.putExtra("textEdit", categoria.toString());
				intent.putExtra("idIcon", categoria.getIdIcon());
				_context.startActivity(intent);
